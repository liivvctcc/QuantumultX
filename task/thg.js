...
function signwx() {
  return new Promise((resolve) => {
    ...
    opts.url = `https://cxdng.cpic.com.cn/taieshop/api/Customerfanspointchange/SignIn`;
...
function getUserInfo() {
  return new Promise((resolve) => {
    const opts = { headers };
    opts.url = `https://cxdng.cpic.com.cn/taieshop/api/CustomerFansInfo/GetFansInfo`;
